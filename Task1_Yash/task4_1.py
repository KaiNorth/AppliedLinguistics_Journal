# -*- coding: utf-8 -*-
"""
Created on Thu May 13 18:21:39 2021
...
def complexity_values_combined_task4_1():
    """
    Get the complexity values with frequencies
    ...
    for i in range(len(lowercase_tokens)):
        df1 = df.where[df['lowercase_tokens']==lowercase_tokens[i]]
        df1 = df1.dropna()
