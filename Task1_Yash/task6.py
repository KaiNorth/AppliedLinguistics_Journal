# -*- coding: utf-8 -*-
"""
Created on Thu May 13 16:07:40 2021
...
def complexity_values_combined_task6():
    """
    The complexity values for each dataset with plural keywords (-'s' at the end)
    
    Returns
    -------
    DataFrame with average complexity values for plural keywords (-'s' at the end)
    """
